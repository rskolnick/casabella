                ...
                {posts.map((post) => (
                    ...
                    >
                        <div className="flex flex-col group cursor-pointer">
                                ...
                                <div className="absolute bottom-0 w-full bg-opacity-10 bg-black backdrop-blur-lg rounded drop-shadow-lg text-white p-5 flex justify-between">
                                    ...
                                    {/* <div className="flex flex-col md:flex-row gap-y-2 md:gap-x-2 items-center">
                                        {post.categories.map((category) => (
                                            <div
                                                key={category._id}
                                                className="bg-[#396fb5] text-center text-white px-3 py-1 rounded-full text-sm font-semibold"
                                            >
                                                <p>{category.title}</p>
                                            </div>
                                        ))}
                            ...
                            <p className="text-white mt-5 font-bold flex items-center group-hover:underline">
                                Read Post
